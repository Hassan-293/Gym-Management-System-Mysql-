...
<form action="connectDietPlan" method="post">
<p style="font-size: 18px;color:#ffffff;  background-color:#000000;"> Enter the Diet Plan Details  </p>  
...
<input type="text"  name="Diet" id="Diet" placeholder="Enter the Diet">
<input type="text"  name="Duration" id="Duration" placeholder="Enter the Duration">
